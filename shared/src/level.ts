...
export const WORLD_TEXTS: WorldText[] = [
  ...
  { x: 1000, y: 8170, text: "the cheese is a lie.", size: 48, rotation: -2 },
  { x: 292, y: 9400, text: "look! a droga szybkiego ruchu!", size: 24, rotation: 2 },
  { x: 270, y: 8300, text: "pick a colour", size: 28, rotation: -3 },
  {
    x: 1270,
    y: 8570,
